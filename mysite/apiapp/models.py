...
class File(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        nparr = np.fromstring(self.file1.read(), np.uint8)
        image = cv2.imdecode(nparr, cv2.IMREAD_COLOR)
        #image = Image.open(self.file1.read())
        width = self.width
...
#             cv2.imwrite(str(z)+images, orig)
#             z = z+1

    # cv2.waitKey(0)
#find_length(0.955, "dc.jpg")
